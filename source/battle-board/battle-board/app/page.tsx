        ...
        <section className="mt-16 w-full text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
            <div className="border border-white rounded-lg p-6 w-64">
              ...
              <img src="/tournament.png" alt="Tournament Mode" className="mt-4" />
            </div>
            <div className="border border-white rounded-lg p-6 w-64">
              <h3 className="text-xl font-bold">Classic</h3>
              <img src="/classic_mode_icon.png" alt="Classic Mode" className="mt-4" />
            </div>
            <div className="border border-white rounded-lg p-6 w-64">
              <h3 className="text-xl font-bold">Rival</h3>
              <img src="/rival_mode_icon.png" alt="Rival Mode" className="mt-4" />
            </div>
          </div>
        </section>
      </main>
